...
const CAI = () => {    
  const [caiData, setCaiData] = useState({    
    ...
    fechaVencimiento: "",    
    resolucionSAR: "",    
    nombreEmpresa: "Óptica Velásquez",    
    rtnEmpresa: "",    
    activo: true,    
    facturasEmitidas: 0    
  });  
        ...
        <Card className="shadow">    
          <CardHeader className="d-flex justify-content-between align-items-center">  
            <div>  
              ...
              <p className="text-muted mb-0">  
                Gestión del Código de Autorización de Impresión para Óptica Velásquez
                {modoEdicion && idCAI && (  
          ...
          <CardBody>    
              ...
              <Col md={8}>    
                <FormGroup>    
                  ...
                  <Input     
                    ...
                    disabled={loading}  
                    placeholder="Ej: Óptica Velásquez"  
                    required    
                  />    
                </FormGroup>    
              </Col>    
              ...
              <Col md={6}>    
                <FormGroup>    
                  ...
                  <Input     
                    ...
                    onChange={handleChange}    
                    placeholder="Ingrese el código CAI asignado por SAR"  
                    disabled={loading}  
                    required    
                  />    
                </FormGroup>    
            ...
            <Row form>    
              ...
              <Col md={4}>    
                <FormGroup>    
                  <Label>Fecha de Vencimiento <span className="text-danger">*</span></Label>    
                  <Input     
                    type="date"    
